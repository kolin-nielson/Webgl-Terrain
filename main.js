...
function terrainHeight(x, y) {
    ...
    // Primary large-scale hills - Increased amplitude for some larger peaks
    height += Math.cos(x * 0.15 + 1.0) * Math.sin(y * 0.1) * 2.2;
    
    // Secondary medium-scale features - Kept reduced amplitude
    height += Math.sin(x * 0.4) * Math.cos(y * 0.3 + 2.0) * 0.6;
    
    // Smaller details and variations - Reduced amplitude
    height += Math.cos(x * 0.8 + y * 0.5) * 0.25;
    height += Math.sin(x * 1.2 - y * 0.9) * 0.15;
    
    // Product of sines/cosines for sharper features - Reduced amplitude
    height += Math.sin(x * 0.6) * Math.cos(y * 0.6) * 0.4;
    
    // Gentle background undulation - Reduced amplitude
